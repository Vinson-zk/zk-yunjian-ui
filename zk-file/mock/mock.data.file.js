...
* @Last Modified time: 2023-11-30 17:57:06
*/
...
// 菜单 -----------------------------------------------
tMenu = {
    pkId: "test.file_file", code: "test.file_file", name: { "zh-CN": "文件", "en-US": "File" },
    path: "f", navCode: navCode, funcModuleCode: funcModuleCode, funcName: 'fileIndex',
...
f = {
    ...
    updateDate: '2023-11-25 16:23:21',
    // children: null
}
mockFs.push(f);
...
for(let i = 0; i < 100; ++i){
    f = {
        ...
        parentCode: 'test_dir', 
        name: 'testDir-num-' + i,
        code: 'test_testDir-num-' + i,   
        originalName: null,  
        contentType: null, 
        size: null, 
        stauts: 1,   
        saveUuid: 'test_saveUuid_dir-num-' + i,   
        saveGroupCode: 'test_saveGroupCode_dir-num-' + i,   
        securityType: 1,
        actionScope: 0,
        sort: 300, 
        type: 1, 
