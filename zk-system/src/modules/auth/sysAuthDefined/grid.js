 ...
 */
const f_getTableColumns = (onEedit, onDetail, onDelete, intl, onShowGrantModal) => {
...
class CInitSysAuthDefinedGrid extends React.Component {
	...
	render() {
		...
		let tableColumns = f_getTableColumns(this.f_edit, this.f_detail, this.f_delete, intl, onShowGrantModal);
