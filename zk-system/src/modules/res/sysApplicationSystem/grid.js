...
const f_getTableColumns = (editFunc, detailFunc, deleteFunc, intl, lang) => {
	...
	return [
				{
			title: zkToolsMsg.msgFormatByIntl(intl, 'zk.sys.res.SysApplicationSystem.name'),
		...
		{
			title: zkToolsMsg.msgFormatByIntl(intl, 'zk.sys.res.SysApplicationSystem.code'),
			textAlign: 'center', dataIndex: 'code', key: 'code', width: 100, 
		},
		{
			title: zkToolsMsg.msgFormatByIntl(intl, 'zk.sys.res.SysApplicationSystem.shortName'),
...
class CInitSysApplicationSystemGrid extends React.Component {
...
export default injectIntl(CInitSysApplicationSystemGrid);