...
class CInitSysResDictTypeIndex extends Component {
...
export default injectIntl(connect(({ mApp, mSysResDictType, loading }) => ({ mApp, mSysResDictType, loading }))(CInitSysResDictTypeIndex));