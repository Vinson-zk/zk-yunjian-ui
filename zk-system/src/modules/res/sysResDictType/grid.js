...
const f_getTableColumns = (onEedit, onDetail, onDelete, intl, lang) => {
	...
	return [
				{
			title: zkToolsMsg.msgFormatByIntl(intl, 'zk.sys.res.SysResDictType.typeCode'),
...
class CInitSysResDictTypeGrid extends React.Component {
	...
	f_changeSelKeys = (selRowKeys, selRows) => {
		this.props.dispatch({ type: "mSysResDictType/setState", payload: { gridSelKeys: selRowKeys } });
	}
		...
		return (
			<ZKScrollTable loading = { gridLoading }
				...
				rowSelection = {{
					...
					selectedRowKeys: mSysResDictType.gridSelKeys||[], 
					columnWidth: '32px'
				}}
				rowKey = "pkId"
...
export default CInitSysResDictTypeGrid;