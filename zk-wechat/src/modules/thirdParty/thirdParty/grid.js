...
const f_getTableColumns = (onEedit, onDetail, onDelete, intl, lang) => {
	...
	return [
		...
		// 	textAlign: 'center', dataIndex: 'wxAppSecret', key: 'wxAppSecret', width: 100, 
		// },
		// {
		// 	title: zkToolsMsg.msgFormatByIntl(intl, 'zk.wechat.thirdParty.ThirdParty.wxToken'),
		// 	textAlign: 'center', dataIndex: 'wxToken', key: 'wxToken', width: 100, 
		// },
		// {
		// 	title: zkToolsMsg.msgFormatByIntl(intl, 'zk.wechat.thirdParty.ThirdParty.wxAesKey'),
		// 	textAlign: 'center', dataIndex: 'wxAesKey', key: 'wxAesKey', width: 100, 
		// },
		// {
		// 	title: zkToolsMsg.msgFormatByIntl(intl, 'zk.wechat.thirdParty.ThirdParty.wxTicket'),
		// 	textAlign: 'center', dataIndex: 'wxTicket', key: 'wxTicket', width: 100, 
		// },
		{
...
class CInitThirdPartyGrid extends React.Component {
	...
	f_changeSelKeys = (selRowKeys, selRows) => {
		this.props.dispatch({ type: "mThirdParty/setState", payload: { gridSelKeys: selRowKeys } });
	}
	...
	render() {
		...
		let { intl, mApp, mThirdParty, loading } = this.props;
        let lang = mApp.lang?mApp.lang:zkToolsMsg.getLocale();

		let tableColumns = f_getTableColumns(this.f_edit, this.f_detail, this.f_delete, intl, lang);

		let gridLoading = loading.effects['mThirdParty/findThirdPartys'];
		...
		return (
			<ZKScrollTable loading = { gridLoading }
				...
				rowSelection = {{
					...
					selectedRowKeys: mThirdParty.gridSelKeys||[], 
					columnWidth: '32px'
				}}
				rowKey = "pkId"
...
export default CInitThirdPartyGrid;