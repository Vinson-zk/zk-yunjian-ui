...
class CInitPayGetNotifyIndex extends Component {
...
export default injectIntl(connect(({ mApp, mPayGetNotify, loading }) => ({ mApp, mPayGetNotify, loading }))(CInitPayGetNotifyIndex));