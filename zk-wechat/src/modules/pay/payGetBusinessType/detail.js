...
class CInitPayGetBusinessTypeDetail extends Component {
	...
	render() {
		...
		let { mApp, mPayGetBusinessType, intl, loading } = this.props;
		let { optEntity = {} } = mPayGetBusinessType;
		let lang = mApp.lang?mApp.lang:zkToolsMsg.getLocale();

		let spinning = loading.effects['mPayGetBusinessType/getPayGetBusinessType'];

		return (
			<ZKSpin spinning={spinning === true} >
				<ZKDetailGrid >
		            <ZKDetailGrid.Row>
						<ZKDetailGrid.ColLabel>{zkToolsMsg.msgFormatByIntl(intl, 'zk.wechat.pay.PayGetBusinessType.name')}:</ZKDetailGrid.ColLabel>
		            ...
		            <ZKDetailGrid.Row>
						<ZKDetailGrid.ColLabel>{zkToolsMsg.msgFormatByIntl(intl, 'zk.wechat.pay.PayGetBusinessType.code')}:</ZKDetailGrid.ColLabel>
						<ZKDetailGrid.ColValue>
							{optEntity.code}
						</ZKDetailGrid.ColValue>
						<ZKDetailGrid.ColLabel>{zkToolsMsg.msgFormatByIntl(intl, 'zk.wechat.pay.PayGetBusinessType.status')}:</ZKDetailGrid.ColLabel>
						<ZKDetailGrid.ColValue>
		            ...
		            <ZKDetailGrid.Row>
						<ZKDetailGrid.ColLabel>{zkToolsMsg.msgFormatByIntl(intl, 'zk.wechat.pay.PayGetBusinessType.startDate')}:</ZKDetailGrid.ColLabel>
						<ZKDetailGrid.ColValue>
							{optEntity.startDate}
						</ZKDetailGrid.ColValue>
						<ZKDetailGrid.ColLabel>{zkToolsMsg.msgFormatByIntl(intl, 'zk.wechat.pay.PayGetBusinessType.endDate')}:</ZKDetailGrid.ColLabel>
						<ZKDetailGrid.ColValue>
							{optEntity.endDate}
						</ZKDetailGrid.ColValue>
					</ZKDetailGrid.Row>       
    ...
    componentDidMount() {
        let { location, dispatch, match, mPayGetBusinessType } = this.props;
		let { params } = match;
		// 第一次进来或地址栏改变了 
...
export default injectIntl(connect(({ mApp, mPayGetBusinessType, loading }) => ({ mApp, mPayGetBusinessType, loading }))(CInitPayGetBusinessTypeDetail));