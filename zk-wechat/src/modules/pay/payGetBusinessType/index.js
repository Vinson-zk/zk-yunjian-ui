...
class CInitPayGetBusinessTypeIndex extends Component {
...
export default injectIntl(connect(({ mApp, mPayGetBusinessType, loading }) => ({ mApp, mPayGetBusinessType, loading }))(CInitPayGetBusinessTypeIndex));