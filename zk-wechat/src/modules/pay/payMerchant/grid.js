...
const f_getTableColumns = (onEedit, onDetail, onDelete, intl, lang) => {
	...
	return [
		{
			title: zkToolsMsg.msgFormatByIntl(intl, 'zk.wechat.pay.PayMerchant.pkId'),
			textAlign: 'center', dataIndex: 'pkId', key: 'pkId', width: 100, 
		},
		{
			title: zkToolsMsg.msgFormatByIntl(intl, 'zk.wechat.pay.PayMerchant.status'),
		...
		// {
		// 	title: zkToolsMsg.msgFormatByIntl(intl, 'zk.wechat.pay.PayMerchant.apiv3AesKey'),
		// 	textAlign: 'center', dataIndex: 'apiv3AesKey', key: 'apiv3AesKey', width: 100, 
		// },
		// {
		// 	title: zkToolsMsg.msgFormatByIntl(intl, 'zk.wechat.pay.PayMerchant.apiKey'),
		// 	textAlign: 'center', dataIndex: 'apiKey', key: 'apiKey', width: 100, 
		// },
		// {
		// 	title: zkToolsMsg.msgFormatByIntl(intl, 'zk.wechat.pay.PayMerchant.apiCertPathPkcs12'),
		// 	textAlign: 'center', dataIndex: 'apiCertPathPkcs12', key: 'apiCertPathPkcs12', width: 100, 
		// },
		// {
		// 	title: zkToolsMsg.msgFormatByIntl(intl, 'zk.wechat.pay.PayMerchant.apiCertPathPem'),
		// 	textAlign: 'center', dataIndex: 'apiCertPathPem', key: 'apiCertPathPem', width: 100, 
		// },
		// {
		// 	title: zkToolsMsg.msgFormatByIntl(intl, 'zk.wechat.pay.PayMerchant.apiCertPathKeyPem'),
		// 	textAlign: 'center', dataIndex: 'apiCertPathKeyPem', key: 'apiCertPathKeyPem', width: 100, 
		// },
		// {
		// 	title: zkToolsMsg.msgFormatByIntl(intl, 'zk.wechat.pay.PayMerchant.apiCertSerialNo'),
		// 	textAlign: 'center', dataIndex: 'apiCertSerialNo', key: 'apiCertSerialNo', width: 100, 
		// },
		{
			title: zkToolsMsg.msgFormatByIntl(intl, 'zk.wechat.pay.PayMerchant.apiCertUpdateDate'),
			textAlign: 'center', dataIndex: 'apiCertUpdateDate', key: 'apiCertUpdateDate', width: 100, 
		},
		{
			title: zkToolsMsg.msgFormatByIntl(intl, 'zk.wechat.pay.PayMerchant.apiCertExpirationTime'),
			textAlign: 'center', dataIndex: 'apiCertExpirationTime', key: 'apiCertExpirationTime', width: 100, 
		},
		{
			title: zkToolsMsg.msgFormatByIntl(intl, 'zk.wechat.pay.PayMerchant.apiCertEffectiveTime'),
			textAlign: 'center', dataIndex: 'apiCertEffectiveTime', key: 'apiCertEffectiveTime', width: 100, 
		},
		{
...
class CInitPayMerchantGrid extends React.Component {
	...
	f_changeSelKeys = (selRowKeys, selRows) => {
		this.props.dispatch({ type: "mPayMerchant/setState", payload: { gridSelKeys: selRowKeys } });
	}
	...
	render() {
		...
		let { intl, mApp, mPayMerchant, loading } = this.props;
        let lang = mApp.lang?mApp.lang:zkToolsMsg.getLocale();

		let tableColumns = f_getTableColumns(this.f_edit, this.f_detail, this.f_delete, intl, lang);

		let gridLoading = loading.effects['mPayMerchant/findPayMerchants'];
		...
		return (
			<ZKScrollTable loading = { gridLoading }
				...
				rowSelection = {{
					...
					selectedRowKeys: mPayMerchant.gridSelKeys||[], 
					columnWidth: '32px'
				}}
				rowKey = "pkId"
...
export default CInitPayMerchantGrid;