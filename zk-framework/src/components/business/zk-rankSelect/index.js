...
class CInitRankSelect extends Component {
	constructor(props) {
        super(props);
        this.state = {
            spinning: false,
...
// 定义属性默认值
CInitRankSelect.defaultProps = {
    ...ZKSelect.defaultProps,
    placeholder: "",
    allowClear: true,
    showSearch: true,
    filterOption: false,
	url: `/${globalAppConfig.apiPrefixSys}/org/sysOrgRank/sysOrgRanksPage`,
	valueKey: 'pkId'
}

export default CInitRankSelect;
