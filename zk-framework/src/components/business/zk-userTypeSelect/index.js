...
function f_doingSearch(url, params) {
	...
	return zkToolsAjax.req(url, {method:'GET', async:false, data:params});
}

class CInitUserTypeSelect extends Component {
	constructor(props) {
        super(props);
        this.state = {
            spinning: false,
	...
	f_triggerChange = (value)=>{
		...
		// console.log("[20220502-1652-001] CInitUserTypeSelect f_triggerChange:", value);
		if (onChange) {
...
// 定义属性默认值
CInitUserTypeSelect.defaultProps = {
    ...ZKSelect.defaultProps,
    placeholder: "",
    allowClear: true,
    showSearch: true,
    filterOption: false,
	url: `/${globalAppConfig.apiPrefixSys}/org/sysOrgUserType/sysOrgUserTypesPage`,
	valueKey: 'pkId'
}

export default CInitUserTypeSelect;
