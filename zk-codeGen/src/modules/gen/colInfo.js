...
* @Last Modified time: 2021-08-21 14:22:33
* 
* 
* 
*/
...
const f_getTableColumns = (intl, isRowEditing, onRowEdit, onRowCancelEdit, onRowSave) => {
	return [
		{
...
class CInitColInfo extends Component {
    ...
    render() {
        ...
        // 列表字段 - 可编辑
        let tableColumns = f_getTableColumns(intl, this.isRowEditing, this.onRowEdit, this.onRowCancelEdit, this.onRowSave);
