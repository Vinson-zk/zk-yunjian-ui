...
* @Last Modified time: 2021-04-17 17:10:17
* 
* 
* 
*/
	...
	render() {
		...
		return (
			<ZKSpin spinning={spinning === true} >
				<ZKDetailGrid >
					<ZKDetailGrid.Row>
						<ZKDetailGrid.ColLeft>{zkToolsMsg.msgFormatByIntl(intl, 'zk.codeGen.funcModule.labelName')}:</ZKDetailGrid.ColLeft>
					...
					<ZKDetailGrid.Row>
						<ZKDetailGrid.ColLeft>{zkToolsMsg.msgFormatByIntl(intl, 'zk.codeGen.funcModule.dbType')}:</ZKDetailGrid.ColLeft>
						<ZKDetailGrid.ColRight>
							{optEntity.dbType}
						</ZKDetailGrid.ColRight>
					</ZKDetailGrid.Row>
					<ZKDetailGrid.Row>
						<ZKDetailGrid.ColLeft>{zkToolsMsg.msgFormatByIntl(intl, 'zk.codeGen.funcModule.url')}:</ZKDetailGrid.ColLeft>
						<ZKDetailGrid.ColRight>
							{optEntity.url}
						</ZKDetailGrid.ColRight>
					</ZKDetailGrid.Row>
