 ...
 * @Last Modified time: 2023-09-23 21:34:21
 */
...
const { ZKContentFormat, ZKOptRow, ZKIcon } = ZKCustomComponents;
...
function FInitZKOptRowDemo({ intl }) {
	...
	return (
		<ZKContentFormat className={styles.sample_detail_panel} >
			<ZKContentFormat title = {`${zkToolsMsg.msgFormatByIntl(intl, 'sample.components.custom.optRow')} ${zkToolsMsg.msgFormatByIntl(intl, 'global.app.info.demo')}`}>
				1 ------------------------------------------------------------------
				...
				<div className={styles.sample_detail_section_row} >
			        ...
			        <ZKOptRow>{["String1, String2"]}</ZKOptRow>
				</div>
				<div className={styles.sample_detail_section_row} >
				...
				<div className={styles.sample_detail_section_row} >
			        ...
			        <ZKOptRow locales={locales} languageChangeFunc={(obj) => { console.log('---------', obj) }}>
						<ZKOptRow.OptGroup>{['String1, String2']}</ZKOptRow.OptGroup>
					</ZKOptRow>
				</div>
