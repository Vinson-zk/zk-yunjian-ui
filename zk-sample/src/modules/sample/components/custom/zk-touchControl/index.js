...
* @Last Modified time: 2023-09-23 21:46:53
*/
...
const { ZKContentFormat, ZKTouchControl } = ZKCustomComponents;
...
const FInitZKTouchControllerDemo = ({ intl }) => {
	...
	return (
		<ZKContentFormat className={styles.sample_detail_panel} >
			<ZKContentFormat style = {{'height':'300px'}} title = {`${zkToolsMsg.msgFormatByIntl(intl, 'sample.components.custom.touchControl')} ${zkToolsMsg.msgFormatByIntl(intl, 'global.app.info.demo')}`}>
