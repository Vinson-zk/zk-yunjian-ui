...
* @Last Modified time: 2023-09-24 00:12:37
* 
* 
* 
*/
	...
	render(){
		...
		return (
			<ZKContentFormat className={styles.sample_detail_panel} >
				<ZKContentFormat title = {`${zkToolsMsg.msgFormatByIntl(intl, 'sample.components.custom.icon')} ${zkToolsMsg.msgFormatByIntl(intl, 'global.app.info.demo')}`}>
					<br />
					<font color = "red">ZKIcon 动态引用 antd4 图标；以及框架图标快速选择。</font>
					<br /><br />
				    <ZKIcon.AntdIcon icon="FormOutlined" style = {{"color":"blue"}} /> &nbsp;&nbsp;
				    <ZKIcon.AntdIcon icon="SendOutlined" /> &nbsp;&nbsp;
				...
				<ZKContentFormat title = {`${zkToolsMsg.msgFormatByIntl(intl, 'global.app.info.declare')}`} >
					...
					ZKIcon.AntdIcon 组件：动态引用 antd4 图标；可接收原始属性；<br />
