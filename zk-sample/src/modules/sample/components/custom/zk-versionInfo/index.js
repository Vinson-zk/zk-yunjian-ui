 ...
 * @Last Modified time: 2023-09-24 21:32:38
 */
...
const { ZKContentFormat, ZKVersionInfo } = ZKCustomComponents;
...
const FInitZKVersionInfoDemo = ({ intl }) => {
  ...
  return (
    <ZKContentFormat className={styles.sample_detail_panel} >
      <ZKContentFormat title = {`${zkToolsMsg.msgFormatByIntl(intl, 'sample.components.custom.versionInfo')} ${zkToolsMsg.msgFormatByIntl(intl, 'global.app.info.demo')}`}>
