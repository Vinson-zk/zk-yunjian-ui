 ...
 * @Last Modified time: 2024-07-14 23:09:08
 */
...
const { ZKContentFormat, ZKLogo } = ZKCustomComponents;
...
const FInitZKLogoDemo = ({ intl }) => {
	...
	return (
		<ZKContentFormat className={styles.sample_detail_panel} >
			<ZKContentFormat title = {`${zkToolsMsg.msgFormatByIntl(intl, 'sample.components.custom.logo')} ${zkToolsMsg.msgFormatByIntl(intl, 'global.app.info.demo')}`}>
