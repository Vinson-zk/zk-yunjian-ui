 ...
 * @Last Modified time: 2023-09-23 21:35:52
 */
...
const { ZKContentFormat, ZKPermission, ZKOptRow } = ZKCustomComponents;
...
const FInitZKPermissionDemo = ({ intl }) => {
  ...
  return (
    <ZKContentFormat className={styles.sample_detail_panel} >
      <ZKContentFormat title = {`${zkToolsMsg.msgFormatByIntl(intl, 'sample.components.custom.permission')} ${zkToolsMsg.msgFormatByIntl(intl, 'global.app.info.demo')}`}>
        <font color="red">ZKPermission 还未完样例；</font>
        <div>
            ...
            <ZKPermission permissions={['edit', 'delete']} >
              ...
              <ZKOptRow >
                <ZKOptRow.OptGroup isAutoPurseUp={true}>
                  <ZKOptRow.OptGroup.OptItem permission={['edit']} icon="EditOutlined" children="g0-修改" onClick={(e) => { console.log('----- g0-修改 ', e) }} />
                  <ZKOptRow.OptGroup.OptItem permission={['test']} icon="tags" children="g0-测试" onClick={(e) => { console.log('----- g0-测试 ', e) }} />
                  <ZKPopconfirm type="delete" >
                    <ZKOptRow.OptGroup.OptItem permission={['delete']} icon="DeleteOutlined" children="g0-删除" onClick={(e) => { console.log('----- g0-删除', e) }} />
                  </ZKPopconfirm>
                </ZKOptRow.OptGroup>

                <ZKOptRow.OptGroup.OptItem permission={['edit']} icon="EditOutlined" children="g1-修改" onClick={(e) => { console.log('----- g1-修改 ', e) }} />

                <ZKOptRow.OptGroup.OptItem permission={['test']} icon="tags" children="g1-测试" onClick={(e) => { console.log('----- g1-测试 ', e) }} />

                <ZKPopconfirm type="delete" >
                  <ZKOptRow.OptGroup.OptItem permission={['delete']} icon="DeleteOutlined" children="g1-删除" onClick={(e) => { console.log('----- g1-删除', e) }} />
                </ZKPopconfirm>

                <ZKOptRow.OptGroup isAutoPurseUp={false}>
                  <ZKOptRow.OptGroup.OptItem permission={['edit']} icon="EditOutlined" children="g3-修改" onClick={(e) => { console.log('----- g3-修改 ', e) }} />
                  <ZKOptRow.OptGroup.OptItem permission={['test']} icon="tags" children="g3-测试" onClick={(e) => { console.log('----- g3-测试 ', e) }} />
                  <ZKPopconfirm type="delete" >
                    <ZKOptRow.OptGroup.OptItem permission={['delete']} icon="DeleteOutlined" children="g3-删除" onClick={(e) => { console.log('----- g3-删除', e) }} />
                  </ZKPopconfirm>
                </ZKOptRow.OptGroup>
              </ZKOptRow>
            </ZKPermission>
