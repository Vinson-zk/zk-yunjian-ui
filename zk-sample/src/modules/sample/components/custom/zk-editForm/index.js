...
const { ZKContentFormat, ZKEditForm, ZKInputJson } = ZKCustomComponents;
	...
	*/
	return (
		<ZKContentFormat className={styles.sample_detail_panel} >
			<ZKContentFormat title = {`${zkToolsMsg.msgFormatByIntl(intl, 'sample.components.custom.editForm')} ${zkToolsMsg.msgFormatByIntl(intl, 'global.app.info.demo')}`}>
