 ...
 * @Last Modified time: 2024-11-18 17:03:17
 */
...
import cLogo from './zk-logo/index.js';
import cNavigation from './zk-navigation/index.js';
import cOptRow from './zk-optRow/index.js';
import cPageSelect from './zk-pageSelect/index.js';
import cPermission from './zk-permission/index.js';
import cRouter from './zk-router/index.js';
...
import cSmartUpload from './zk-smartUpload/index.js';
...
const customIndex = { component:cIndex, models:[]};
...
const customLogo = { component:cLogo, models:[]};
const customNavigation = { component:cNavigation, models:[]};
const customOptRow = { component:cOptRow, models:[]};
const customPageSelect = { component:cPageSelect, models:[]};
const customPermission = { component:cPermission, models:[]};
const customRouter = { component:cRouter, models:[]};
...
const customSmartUpload = { component:cSmartUpload, models:[]};
