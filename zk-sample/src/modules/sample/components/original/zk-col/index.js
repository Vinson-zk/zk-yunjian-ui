 ...
 * @Last Modified time: 2020-08-16 09:17:09
 */
	...
	return (
		<div className={styles.sample_detail_panel}>
			<div className={styles.sample_detail_section}>
				<h2>1、{zkToolsMsg.msgFormatByIntl(intl, 'sample.components.original.col')}&nbsp;{zkToolsMsg.msgFormatByIntl(intl, 'global.app.info.demo')}</h2>
				<div><ZKCol >Col 原生态封装</ZKCol></div>
			</div>
			<div className={styles.sample_detail_section}>
