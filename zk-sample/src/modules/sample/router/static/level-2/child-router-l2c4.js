 ...
 *
 * @Author: Vinson
 * @Date: 2020-08-14 10:20:41
 * @Last Modified by: Vinson
 * @Last Modified time: 2020-08-14 10:49:34
 */
...
class CInitChildRouterL2C4 extends React.Component {
  render() {
    ...
    return (
      <div style={{ border: '1px solid #f0f' }} >{zkToolsMsg.msgFormatByIntl(intl, 'sample.router.name')}:{match.path}
            在上级路由的容器中进行组件切换
        <ul >
          <li>
