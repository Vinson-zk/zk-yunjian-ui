    ...
    return (
        <ZKContentFormat className={styles.sample_detail_panel} >
            <div className={styles.sample_detail_top_affix} >
                <ZKAnchor items={[
                    {
                        'key': `${globalAppConfig.basename}${match.path}/#registerModel`,
                        'href': `${globalAppConfig.basename}${match.path}/#registerModel`,
                        'title': 'registerModel'
                    },{
                        'key': `${globalAppConfig.basename}${match.path}/#unRegisterModel`,
                        'href': `${globalAppConfig.basename}${match.path}/#unRegisterModel`,
                        'title': 'unRegisterModel'
                    },{
                        'key': `${globalAppConfig.basename}${match.path}/#makeDynamicComponent`,
                        'href': `${globalAppConfig.basename}${match.path}/#makeDynamicComponent`,
                        'title': 'makeDynamicComponent'
                    },{
                        'key': `${globalAppConfig.basename}${match.path}/#getRoutesByNavs`,
                        'href': `${globalAppConfig.basename}${match.path}/#getRoutesByNavs`,
                        'title': 'getRoutesByNavs'
                    },{
                        'key': `${globalAppConfig.basename}${match.path}/#getIndexNav`,
                        'href': `${globalAppConfig.basename}${match.path}/#getIndexNav`,
                        'title': 'getIndexNav'
                    },{
                        'key': `${globalAppConfig.basename}${match.path}/#navIsShow`,
                        'href': `${globalAppConfig.basename}${match.path}/#navIsShow`,
                        'title': 'navIsShow'
                    },{
                        'key': `${globalAppConfig.basename}${match.path}/#getRoutesByMenus`,
                        'href': `${globalAppConfig.basename}${match.path}/#getRoutesByMenus`,
                        'title': 'getRoutesByMenus'
                    },{
                        'key': `${globalAppConfig.basename}${match.path}/#getIndexMenu`,
                        'href': `${globalAppConfig.basename}${match.path}/#getIndexMenu`,
                        'title': 'getIndexMenu'
                    },{
                        'key': `${globalAppConfig.basename}${match.path}/#getMenuName`,
                        'href': `${globalAppConfig.basename}${match.path}/#getMenuName`,
                        'title': 'getMenuName'
                    },{
                        'key': `${globalAppConfig.basename}${match.path}/#menuIsShow`,
                        'href': `${globalAppConfig.basename}${match.path}/#menuIsShow`,
                        'title': 'menuIsShow'
                    },{
                        'key': `${globalAppConfig.basename}${match.path}/#menuIsLeaf`,
                        'href': `${globalAppConfig.basename}${match.path}/#menuIsLeaf`,
                        'title': 'menuIsLeaf'
                    },{
                        'key': `${globalAppConfig.basename}${match.path}/#getRouterMapping`,
                        'href': `${globalAppConfig.basename}${match.path}/#getRouterMapping`,
                        'title': 'getRouterMapping'
                    },{
                        'key': `${globalAppConfig.basename}${match.path}/#getDynamicImportHelper`,
                        'href': `${globalAppConfig.basename}${match.path}/#getDynamicImportHelper`,
                        'title': 'getDynamicImportHelper'
                    }
                ]} />
            </div>
            <ZKContentFormat title = {`${zkToolsMsg.msgFormatByIntl(intl, 'sample.general.function')} zkToolsNavAndMenu ${zkToolsMsg.msgFormatByIntl(intl, 'global.app.info.demo')}`}>
            ...
            <ZKContentFormat title = {`公共函数  ${zkToolsMsg.msgFormatByIntl(intl, 'global.app.info.declare')}`} >
                ...
                <ZKContentFormat title = {`导航栏目函数  ${zkToolsMsg.msgFormatByIntl(intl, 'global.app.info.declare')}`} >
                ...
                <ZKContentFormat title = {`菜单路由处理函数  ${zkToolsMsg.msgFormatByIntl(intl, 'global.app.info.declare')}`} >
                ...
                <ZKContentFormat title = {`路由路径的映射  ${zkToolsMsg.msgFormatByIntl(intl, 'global.app.info.declare')}`} >
                ...
                <ZKContentFormat title = {`其他导入或菜单处理函数  ${zkToolsMsg.msgFormatByIntl(intl, 'global.app.info.declare')}`} >
