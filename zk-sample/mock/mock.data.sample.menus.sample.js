...
// 原生组件封装的子菜单： ZKCol
tMenu = {
	pkId:"sample_zkOriginalComponents_configProvider", key:"sample_zkOriginalComponents_configProvider", name:{"zh-CN":"ZK全局配置","en-US":"ZKConfigProvider"}, 
	path:"configProvider", navCode: navCodeSample, funcModuleCode: navCodeSample, funcName: "originalConfigProvider",
	isIndex:0, exact:true, isFrame:0, isShow:1, icon:"AntDesignOutlined", sort:35, 
	permission:null, parentId:"sample_zkOriginalComponents", children:null
}
sampleMenus.push(tMenu);
...
tMenu = {
	...
	isIndex:0, exact:true, isFrame:0, isShow:1, icon:"CodepenOutlined", sort:20, 
	permission:null, parentId:"sample_zk_components", children:null
}
sampleMenus.push(tMenu);
// 自定组件的子菜单：ZKAutoMenu
...
sampleMenus.push(tMenu);
// 自定组件的子菜单：ZKContentFormat
tMenu = {
	pkId:"sample_zkCustomComponents_ZKContentFormat", key:"sample_zkCustomComponents_ZKContentFormat", name:{"zh-CN":"ZK内容版式","en-US":"ZKContentFormat"}, 
	path:"contentFormat", navCode: navCodeSample, funcModuleCode: navCodeSample, funcName: "customContentFormat",
	isIndex:0, exact:true, isFrame:0, isShow:1, icon:"AntDesignOutlined", sort:25, 
	permission:null, parentId:"sample_zkCustomComponents", children:null
}
sampleMenus.push(tMenu);
...
tMenu = {
	...
	isIndex:0, exact:true, isFrame:0, isShow:1, icon:"AntDesignOutlined", sort:115, 
	permission:null, parentId:"sample_zkCustomComponents", children:null
}
sampleMenus.push(tMenu);
// 自定组件的子菜单：ZKRouter
...
// 自定组件的子菜单： ZKTheme
tMenu = {
	pkId:"sample_zkCustomComponents_ZKTheme", key:"sample_zkCustomComponents_ZKTheme", name:{"zh-CN":"ZK主题","en-US":"ZKTheme"}, 
	path:"theme", navCode: navCodeSample, funcModuleCode: navCodeSample, funcName: "customTheme",
...
/** ------------------------------------- 业务组件 */
tMenu = {
	pkId:"sample_zkBusinessComponents", key:"sample_zkBusinessComponents", name:{"zh-CN":"ZK业务组件","en-US":"ZKBusiness"}, 
	path:"business", navCode: navCodeSample, funcModuleCode: navCodeSample, funcName: "businessIndex",
	isIndex:0, exact:true, isFrame:0, isShow:1, icon:"CodepenOutlined", sort:10, 
	permission:null, parentId:"sample_zk_components", children:null
}
sampleMenus.push(tMenu);
...
/********************************************* 颜色定义 */
tMenu = {
	pkId: "sample_others", code: "sample_others", name: { "zh-CN": "其他", "en-US": "Other" },
	path: "other", navCode: navCodeSample, funcModuleCode: '', funcName: '',
...
// 主题
tMenu = {
	pkId: "sample_theme_definition", code: "sample_theme_definition", name: { "zh-CN": "主题定义", "en-US": "Theme Definition" },
	path: "theme_definition", navCode: navCodeSample, funcModuleCode: navCodeSample, funcName: 'themeDefinition',
	isIndex: 0, exact: true, isFrame: 0, isShow: 1, icon: "TagsOutlined", sort: 100,
	/* permission:,*/ parentId: "sample_others", //children:null
}
sampleMenus.push(tMenu);
