...
* @Last Modified time: 2024-06-24 17:18:26
*/
...
module.exports = {
    ...
    ['GET /apiMock/res/getNavMenus/:navCode'](req, res){
        ...
        let resJsonData = { code: 'zk.0', ok: true, msg: 'developmentTool.mock GET /apiMock/res/getNavMenus/:navCode ok!', data: devToolMenus };
