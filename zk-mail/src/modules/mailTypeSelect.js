/*
* @Author: Vinson
* @Date:   2022-05-26 17:38:52
* @Last Modified by:   Vinson
* @Last Modified time: 2022-05-26 18:48:09
*/
...
import { findMailTypes } from "./mailType/service.js";

class CInitMailTypeSelect extends Component {
	constructor(props) {
        super(props);
        this.state = {
            spinning: false,
	...
	render(){
		...
		return (
			<ZKSelect style={{width: 380}} {...otherProps}  loading = { this.state.spinning } 
	            ...
	            {this.state.listDatas.map((item, index)=>{
	                return <ZKSelect.Option key={index} value={item[valueKey]}>{zkToolsMsg.getInternationInfo(item.typeName)}[{item.typeCode}]</ZKSelect.Option>
	            })}
	        </ZKSelect>
	    )
	}
...
// 定义属性默认值
CInitMailTypeSelect.defaultProps = {
...
export default CInitMailTypeSelect;
