...
module.exports = {
	...
	// 标签名
	"zk.front.end.login.lable.login.by.third.user":"第三方账号登录",
	"zk.front.end.login.lable.login.user.type.personalUser":"个人用户登录",
	"zk.front.end.login.lable.login.user.type.enterpriseUser":"企业用户登录",
	...
	// 验证消息
	"zk.front.end.login.vMsg.companyCode":"请输入公司代码",
	"zk.front.end.login.vMsg.username":"请输入您的用户名!",	
	"zk.front.end.login.vMsg.password":"请输入您的密码!",
	"zk.front.end.login.vMsg.phoneNumber":"请输入您的手机号码!",
	"zk.front.end.login.vMsg.validCode":"请输入您的手机验证码!",
