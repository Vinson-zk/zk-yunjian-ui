...
module.exports = (env, args, isDev=false) => {
    ...
    // entry 入口
    webpackConfig.entry['zkApp'] = packagePath.resolve(__dirname, '../src/app');
    // outout 输出
    ...
    // 引入项目架包并给其定义一个别名
    webpackConfig.resolve.alias['zkFramework'] = packagePath.resolve(__dirname, '../../zk-framework');
    webpackConfig.resolve.alias['zkSample'] = packagePath.resolve(__dirname, '../../zk-sample');
    webpackConfig.resolve.alias['zkSystem'] = packagePath.resolve(__dirname, '../../zk-system');
    webpackConfig.resolve.alias['zkDevelopmentTool'] = packagePath.resolve(__dirname, '../../zk-developmentTool');
    ...
    packageWebpackConfig.packageDefaultRules.babel_loader.include.push(packagePath.resolve(__dirname, "../../zk-sample"));
    packageWebpackConfig.packageDefaultRules.babel_loader.include.push(packagePath.resolve(__dirname, "../../zk-system"));
    packageWebpackConfig.packageDefaultRules.babel_loader.include.push(packagePath.resolve(__dirname, "../../zk-developmentTool"));
