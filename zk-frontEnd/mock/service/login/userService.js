...
* @Last Modified time: 2024-06-27 23:37:40
* 
*/

let pnTicketId = '_tkid'; // 令牌ID 参数名
...
module.exports = {
	['GET /apiMock/sec/loginUserInfo'](req, res) {
        ...
        let resJsonData = { code: 'zk.0', ok: true, msg: 'mock GET /apiMock/sec/loginUserInfo ok' }

        if (headers[pnTicketId] == "apiMock-accountLogin") {
        	resJsonData.data = { 
    			user: { "pkId": "pkId", "username": "admin", "nickname": "Mock 账号", "newMsg": 2 } 
    		};
            
        } else if (headers[pnTicketId] == "apiMock-phoneNumberLogin") {
        	resJsonData.data = { 
    ...
    ['POST /apiMock/sec/login'](req, res) {
        ...
        let resJsonData = { code: 'zk.0', ok: true, msg: 'mock POST /apiMock/sec/login ok' }
        ...
        if (dataBody.username == "admin") {
        	if (dataBody.pwd == "admin") {
                ...
                resJsonData.data[pnTicketId] = 'apiMock-accountLogin';
        	}else{
    ...
    ['POST /apiMock/sec/phoneNumberLogin'](req, res) {
        ...
        let dataBody = req.body;
        let resJsonData = { code: 'zk.0', ok: true, msg: 'mock POST /apiMock/sec/phoneNumberLogin ok' }
